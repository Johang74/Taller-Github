SubProceso  eliminarUsuario ( existeUsuario Por Referencia, idUsuario Por Referencia, arregloId Por Referencia, arregloNombres Por Referencia, arregloNotas Por Referencia )
	existeUsuario <- Falso;
...
SubProceso ingresarUsuario ( estaLleno Por Referencia, i, arregloId Por Referencia,idUsuario Por Referencia,nombre Por Referencia, nota Por Referencia, arregloNombres Por Referencia, arregloNotas Por Referencia )
	estaLleno <- Verdadero;
	Para i<-0 Hasta 7 Con Paso 1 Hacer
...
Proceso Ocho
	...
	Mientras salir == falso Hacer
		...
		Segun opc Hacer
			1:
				ingresarUsuario( estaLleno, i, arregloId,idUsuario,nombre, nota, arregloNombres, arregloNotas);
				
			2:
				
				eliminarUsuario( existeUsuario, idUsuario, arregloId, arregloNombres, arregloNotas );
