SubProceso  verVehiculo (placa, existeVehiculo, i, arregloPlacas Por Referencia, arregloMarcas Por Referencia, arregloNombres Por Referencia, arregloNum Por Referencia)
...
SubProceso retirarVehiculo (i, existeVehiculo,placa,arregloPlacas Por Referencia,arregloMarcas Por Referencia,arregloNombres Por Referencia, arregloNum Por Referencia )
	existeVehiculo <- Falso;
...
SubProceso agregarVehiculo (i,estaLleno Por Referencia, arregloPlacas Por Referencia,placa Por Referencia,marca Por Referencia,nombre Por Referencia,num Por Referencia,arregloMarcas Por Referencia,arregloNombres Por Referencia,arregloNum Por Referencia )
	estaLleno <- Verdadero;
	Para i<-0 Hasta 4 Con Paso 1 Hacer
	...
	Mientras salir == falso Hacer
		...
		Segun opc Hacer
			1:
				...
				agregarVehiculo(i,estaLleno, arregloPlacas,placa,marca,nombre,num,arregloMarcas,arregloNombres,arregloNum );
				
				
			2:
				
				retirarVehiculo( i,existeVehiculo,placa,arregloPlacas,arregloMarcas,arregloNombres, arregloNum); 
				
			3:
				verVehiculo(placa, existeVehiculo, i, arregloPlacas, arregloMarcas, arregloNombres, arregloNum);
